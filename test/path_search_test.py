...
def test_similarity_search():
    ...
    text = "Hi"
    workflow_triggered, df_definitions, df_search_sections = similarity_search(chat_data_for_search, text)
    ...
    workflow_triggered, relevant_definitions, relevant_sections = similarity_search(chat_data_for_search, "Can I see this on a map?")
