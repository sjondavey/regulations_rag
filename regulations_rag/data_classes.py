...
# # class AnswerClassification(Enum):
# #     WITH_RAG = "The system sucessfully used RAG to answer the user question"
# #     WITHOUT_RAG = "The system answered the user question without reference material"

# #     def create_openai_content(self) -> str:
# #         return ""

# @dataclass
# class AnswerResponse(AssistantResponse, ABC):
#     # This is still an abstract class - only use classes that inherit from this one
#     sub_classification: AnswerClassification
#     answer: str
...
#         super().__init__(classification=AssistantMessageClassification.ANSWER)
#         super().__post_init__()  # Call parent's __post_init__
#         if not isinstance(self.sub_classification, AnswerClassification):
#             raise ValueError("Sub classification must be an instance of AnswerClassification")
